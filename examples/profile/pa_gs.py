...
def init_process(rank, world_size, backend):
    ...
    dist.init_process_group(
        backend, rank=rank, world_size=world_size)  # 初始化进程组
...
if __name__ == '__main__':
    ...
    parser.add_argument("--remote-sample",
                        dest='remote_sample', action='store_true')
